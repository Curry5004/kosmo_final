    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarScroll">
            ...
            <a class="btn btn-primary" href="index.jsp" role="button">로그인</a>
            <a class="btn btn-primary" href="index.jsp" role="button">회원가입</a>
            <a class="btn btn-primary" href="index.jsp" role="button">방개설</a>
            <a class="btn btn-primary" href="index.jsp" role="button">마이페이지</a>
            <a class="btn btn-primary" href="index.jsp" role="button">로그아웃</a>
            <a class="btn btn-primary" href="index.jsp" role="button">관리자모드</a>
        </ul>
		<form action="getPartyList.do" method="get">
	        <input name="SEARCH_KEYWORD" type="text"></input>
			<input type="button" value="모임찾기"></input>
		</form>
