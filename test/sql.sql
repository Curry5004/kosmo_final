...
CREATE TABLE `PARTY` (
	...
	`PARTY_PRE_MBTI1`	INT NOT NULL,
	`PARTY_PRE_MBTI2`	INT 	NULL,
	`PARTY_PRE_MBTI3`	INT 	NULL,
	`PARTY_PRE_MBTI4`	INT 	NULL,
	`CATEGORY_NAME`	VARCHAR(255) 	NOT NULL,
	`PARTY_INTRODUCE`	VARCHAR(255) NOT NULL,
	`PARTY_LOCATION`	VARCHAR(255) 	NOT NULL,
	`PARTY_TUMB`	VARCHAR(255)   NULL,
...
ALTER TABLE `PARTY` ADD CONSTRAINT `FK_MBTI_TO_PARTY_1` FOREIGN KEY (
	`PARTY_PRE_MBTI1`
)
REFERENCES `MBTI` (
	`MBTI_ID`
...
ALTER TABLE `PARTY` ADD CONSTRAINT `FK_MBTI_TO_PARTY_2` FOREIGN KEY (
	`PARTY_PRE_MBTI2`
)
REFERENCES `MBTI` (
	`MBTI_ID`
...
ALTER TABLE `PARTY` ADD CONSTRAINT `FK_MBTI_TO_PARTY_3` FOREIGN KEY (
	`PARTY_PRE_MBTI3`
)
REFERENCES `MBTI` (
	`MBTI_ID`
...
ALTER TABLE `PARTY` ADD CONSTRAINT `FK_MBTI_TO_PARTY_4` FOREIGN KEY (
	`PARTY_PRE_MBTI4`
)
REFERENCES `MBTI` (
	`MBTI_ID`
...
PARTY_LOCATION,PARTY_MAXIMUM,PARTY_REG_DATE)
 VALUES('테스트용 그룹','관리자','11','업종/직무','열심히 코딩하는 곳입니다','한국소프트웨어인재개발원',30,now());
...
select * from board_comment where PARTY_ID=1;
