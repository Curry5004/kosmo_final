...
public class PartyVO {
	...
	public String toString() {
		return "PartyVO [PARTY_ID=" + PARTY_ID + ", PARTY_TITLE=" + PARTY_TITLE + ", PARTY_CREATOR=" + PARTY_CREATOR
				...
				+ ", PARTY_INTRODUCE=" + PARTY_INTRODUCE + ", PARTY_LOCATION=" + PARTY_LOCATION + ", PARTY_TUMB_PATH="
				+ PARTY_TUMB_PATH + ", PARTY_MAXIMUM=" + PARTY_MAXIMUM + ", PARTY_RATE1=" + PARTY_RATE1
				+ ", PARTY_RATE2=" + PARTY_RATE2 + ", PARTY_RATE3=" + PARTY_RATE3 + ", PARTY_REG_DATE=" + PARTY_REG_DATE
				+ ", PARTY_AVAILABLE=" + PARTY_AVAILABLE + ", SEARCH_KEYWORD=" + SEARCH_KEYWORD + "]";
	}
