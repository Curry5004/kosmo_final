        ...
        <form method="post" action="registry.do" name="userInfo" enctype="multipart/form-data">
            <table>
                ...
                <tr>
                    ...
                    <td>
                    <div class="map_wrap">
				    <div id="map" style="width:200%;height:100%;position:relative;overflow:hidden;"></div>
				    ...
				    <div id="menu_wrap" class="bg_white">
                        ...
                        <input type="text" size="50" name="location" placeholder="시, 구 까지만 작성해 주세요 ex)서울특별시 금천구" id="address"/>
                    </td>
                </tr>
                <tr>
...
<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=8159dce1cf59e2e917f7411a46d56597&libraries=services"></script>
<script>
    ...
    for ( let i=0; i<places.length; i++ ) {
        ...
        (function(marker, title) {
            ...
            itemEl.onclick =  function () {
                displayInfowindow(marker, title);
                var msg=JSON.parse(JSON.stringify(places[i].address_name));
                console.log(msg);
