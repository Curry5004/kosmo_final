	...
	<div class="container pt-5">
	    ...
	    <c:if test="${cnt.user_id == sessionScope.user.user_Id}">  
			      ...
			      <div class="form-check">
			      		...
			      		<br>
			      		<br />
  						<input class="form-check-input" type="checkbox" id="check1" name="option1" value="something" name="rate1" checked> 
  						...
  						<br />
  						<br />
  						<input class="form-check-input" type="checkbox" id="check1" name="option1" value="something" name="rate2" checked>
  						<label class="form-check-label">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
  						<input class="form-check-input" type="checkbox" id="check1" name="option1" value="something" name="rate2" checked>
  						<label class="form-check-label">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
  						<input class="form-check-input" type="checkbox" id="check1" name="option1" value="something" name="rate2" checked>
  						...
  						<br>
  						<br />
  						<input class="form-check-input" type="checkbox" id="check1" name="option1" value="something" name="rate3" checked>
  						<label class="form-check-label">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
  						<input class="form-check-input" type="checkbox" id="check1" name="option1" value="something" name="rate3" checked>
  						<label class="form-check-label">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
  						<input class="form-check-input" type="checkbox" id="check1" name="option1" value="something" name="rate3" checked>
